...
iteration = 1
path = "." 
prmtop = AmberPrmtopFile(f"{path}/AA-MD-{iteration}/step3_input.parm7")
inpcrd = AmberInpcrdFile(f"{path}/AA-MD-{iteration}/step3_input.rst7")
...
system = prmtop.createSystem(
    ...
    rigidWater=True, ewaldErrorTolerance=0.0005, hydrogenMass=1.5*amu,
)
...
simulation.step(nb_steps) # 125ns
