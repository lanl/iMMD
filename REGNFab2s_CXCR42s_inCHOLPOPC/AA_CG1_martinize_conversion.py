...
os.system(f"martinize2 -f AA-MD-{iteration}-solu-final.pdb -x CG-MD-{iteration}-solu-initial.pdb -o system.top -resid input -p backbone -pf 1000 -dssp {dssp} -from charmm -ff martini3001 -elastic -ef 1000.0 -el 0 -eu 0.9 -ea 0 -ep 1.0 -eunit chain -scfix -cys auto -nt -maxwarn 1")
